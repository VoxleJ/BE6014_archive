%% Problem 1 part 2 mu 1e+05 change hike
clear all 
close all
...
f2 = figure('Name', 'Part 2 Plot over scatter, mu = 1e+05, 5,5 hikes');

scatter(t,y)
hold on
plot(t, model10a)
title('Raw Data and Fit Part 2, \mu = 1e+05, 5,5 hikes')
xlabel('time')
ylabel('displacement')

%% Echoing outputs for diary
diary vjprob1pt2_groupD.txt
